...
function ENT:Destruct(dmg)
    ...
    util.BlastDamage(self, attacker, vPoint, self.blastRadius, self.blastDamage)
...
function ENT:Use(activator, caller)
    ...
    if weapon_count >= GAMEMODE.Config.maxguns then
        DarkRP.notify(activator, 1, 4, DarkRP.getPhrase("gunlablimit"))
        return
    end
    ...
    DarkRP.notify(activator, 0, 3, "Crafting random weapon for " .. DarkRP.formatMoney(cost))
    ...
    timer.Create(self:EntIndex() .. self.itemPhrase, self.craftTime, 1, function()
