...
IMDE.StaminaDamageMultipliers = {
    ...
    [DMG_SLASH] = {0.5, 0.5, 0}, -- NPCs use this damage on stunstick/crowbar, which isn't right!
    [DMG_CLUB] = {0.25, 0.1, 0.5},
    [DMG_CRUSH] = {2, 0.25, 0.5}, -- physics damage

    [DMG_BLAST] = {0.75, 0.8, 2},

    [DMG_NERVEGAS] = {2, 0, 1}, -- cs gas (nonlethal). hardcoded to not cause knockdowns
    [DMG_SHOCK] = {1, 0.25, 1}, -- shock (stungun?)
    [DMG_FALL] = {1, 0.5, 1}, -- fall damage
